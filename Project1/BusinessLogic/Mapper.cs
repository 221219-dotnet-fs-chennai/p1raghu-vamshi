...
namespace BusinessLogic
{
    public class Mapper
    {
        ...
        public static IEnumerable<Modules.UserDetails> Map(IEnumerable<Da.UserDetail> userDetails)
        {
        ...
        public static IEnumerable<Modules.Education> Map(IEnumerable<Da.Education> education)
        {
        ...
        public static IEnumerable<Modules.Address> Map(IEnumerable<Da.Address> address)
        {
        ...
        public static IEnumerable<Modules.Company> Map(IEnumerable<Da.Company> company)
        {
            return company.Select(Map);
        }
        public static Da.Skill Map(Modules.Skills sk)
        {
            return new Da.Skill()
            {
                UserId = sk.userId,
        ...
        public static Modules.Skills Map(Da.Skill sk)
        {
            return new Modules.Skills()
            {
                userId= sk.UserId, 
                SkillId= sk.SkillId,
                SkillName= sk.SkillName,
        ...
        public static IEnumerable<Modules.Skills> Map(IEnumerable<Da.Skill> skills)
        {
