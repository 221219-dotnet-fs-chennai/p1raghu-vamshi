...
namespace ConsoleProject
{
    public class AddCompanyDetails:IMenu
    {
        ...
        public void Display()
        {
            ...
            Console.WriteLine("[7] userId - " + company.userId);
            Console.WriteLine("[6] CompanyName - " + company.CompanyName);            
            Console.WriteLine("[5] CompanyLocation - " + company.CompanyLocation);
            Console.WriteLine("[4] Experience - " + company.Experience);
            Console.WriteLine("[3] CompanyEmail - " + company.CompanyEmail);
            Console.WriteLine("[2] Website - " + company.Website);
