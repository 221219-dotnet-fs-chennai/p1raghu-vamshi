...
namespace ConsoleProject
{
    public class AddAddressDetails:IMenu
    {
        ...
        public void Display()
        {
            ...
            Console.WriteLine("[6] userId - " + address.userId);
            Console.WriteLine("[5] userAddress - " + address.userAddress);
            Console.WriteLine("[4] country - " + address.country);
            Console.WriteLine("[3] pincode - " + address.pincode);
        ...
        public string UserChoice()
        {
            ...
            switch (userInput)
            {
                ...
                case "1":
                    ...
                    RRR.Add(address);
                    return "GetAllDetails"; // "AddAddressDetails"; // return "any other pages"
                case "2":
                    RRR.GetDetails();
                    return "Menu";
                case "6":
