...
namespace ConsoleProject
{
    public class AddEducationDetails:IMenu
    {
        ...
        public void Display()
        {
            ...
            Console.WriteLine("[7] userId - " + education.userId);
            Console.WriteLine("[6] University - " + education.University);
            //Console.WriteLine("[7] Phone - " + newRestaurant.Phone);
            Console.WriteLine("[5] UG - " + education.UG);
            Console.WriteLine("[4] Specialization - " + education.Specialization);
            Console.WriteLine("[3] PassedOutYear - " + education.PassedOutYear);
            Console.WriteLine("[2] grade - " + education.grade);
